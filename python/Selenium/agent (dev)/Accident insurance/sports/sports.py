...
type = driver.find_element(By.XPATH, "(//ul[@class='el-scrollbar__view el-select-dropdown__list'])[2]//li[2]")
type.click()

time.sleep(1)

work = driver.find_element(By.XPATH, "(//input[@class='el-input__inner'])[2]")
work.click()

time.sleep(1)

work1 = driver.find_element(By.XPATH, "(//ul[@class='el-scrollbar__view el-select-dropdown__list'])[4]//li")
work1.click()

time.sleep(1)

mans = driver.find_element(By.XPATH, "//input[@type='number']")
mans.click()
mans.send_keys(Keys.BACKSPACE)

time.sleep(1)

time_menu = driver.find_element(By.XPATH, "(//input[@class='el-input__inner'])[3]")
time_menu.click()

time_menu1 = driver.find_element(By.XPATH, "(//ul[@class='el-scrollbar__view el-select-dropdown__list'])[4]//li")
time_menu1.click()
...
menu3 = driver.find_element(By.XPATH, "(//ul[@class='el-scrollbar__view el-select-dropdown__list'])[9]//li[2]")
menu3.click()
