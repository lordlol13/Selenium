...
type = driver.find_element(By.XPATH, "(//ul[@class='el-scrollbar__view el-select-dropdown__list'])[2]//li[1]")
type.click()
...
time_menu = driver.find_element(By.XPATH, "(//input[@class='el-input__inner'])[2]")
time_menu.click()
